 ...
 * ===============================================================
 * Autor        : Militza Fernández
 * Fecha        : 21 abril 2025
 * Proyecto     : Simulación de venta de entradas en un teatro
 * Lenguaje     : Java
 *
...
// Lista que almacena todas las entradas compradas durante la sesión
    ...
    public static void main(String[] args) {
        ...
        for (;;) {
            ...
            System.out.println("| 8. Buscar entrada                               |");            
            System.out.println("| 9. Salir                                        |");
            System.out.println("|=================================================|");
            System.out.print("Seleccione una opcion: ");
            opcion = pedirEnteroEnRango("Seleccione una opcion (1-9): ", 1, 9);

            switch (opcion) {
                case 1 -> reservarEntrada();       // Nueva función
                case 2 -> comprarEntrada();
                case 3 -> modificarVenta();        // Nueva función
                case 4 -> eliminarEntrada();
                case 5 -> imprimirBoleta();        // Nueva función
                case 6 -> verPromociones();
                case 7 -> confirmarReserva();      // Nueva función
                case 8 -> buscarEntrada();
                case 9 -> {
